      ...
      <div className="container">
        <div className="row">
          <div className="col-lg-5">
            <div
              className="tp-progress-bar-box wow fadeInUp"
              data-wow-duration="1s"
              data-wow-delay=".3s"
            >
          ...
          <div className="col-lg-4">
            <div
              className="tp-progress-item p-relative wow fadeInUp"
              data-wow-duration="1s"
              data-wow-delay=".5s"
            ...
            >
              ...
              <div className="tp-progress-item-shape">
                <Image src={progressThumb2} alt="Dekho Land progress statistics" />
              </div>
            </div>
          </div>
          <div className="col-lg-3">
            <div
              className="tp-progress-count-box text-center wow fadeInUp"
              data-wow-duration="1s"
              data-wow-delay=".7s"
            >
