...
export const metadata: Metadata = {
  ...
  title:
    "Legal Verification of Property in Hyderabad: The Complete Due Diligence Guide | Dekho Land",
  description:
  ...
  alternates: {
    canonical: "/services/legal-verification",
  },
  openGraph: {
    title:
      "Legal Verification of Property in Hyderabad: The Complete Due Diligence Guide",
    description:
    ...
    url: "https://www.dekholand.com/services/legal-verification",
    siteName: "Dekho Land",
    type: "article",
  },
  twitter: {
